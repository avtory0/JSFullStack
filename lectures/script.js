...
// //метод  substring() похож на slice(), за исключением того, что первый аргумент может принимать значение больше 2
...
const num  =5;
console.log("http://vk.com/catalog/" + num); //конкатенация
...
//2)
console.log(typeof(+'4')); //благодаря унарнорму плюсу можно преобразовать в число

// 3)
console.log(typeof(parseInt("15px", 10)));//parseInt 1 аргумент - исходная строка, 2 - система исчисления
...
//3)
console.log(typeof(!!"44444")); // два знака отрицания преобразуют в false




//27 Задачи с собеседования

// let x = 5;
// alert(x++);

// [ ] + false - null + true 
// console.log([] + false - null + true);// NaN - not a number, т.к мы отнимаем null, а это не мат действие
...
// оператор && запинается на ЛОжь, а именно на null
